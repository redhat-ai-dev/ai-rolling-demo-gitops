...
- The [Adoption Insights Plugin](https://github.com/redhat-developer/rhdh-plugins/tree/main/workspaces/adoption-insights), which increases the visibility into Red Hat Developer Hub usage with key adoption metrics, catalog engagement trends, top plugin trends, and user growth insight, helping platform teams make informed, data-driven improvements.
